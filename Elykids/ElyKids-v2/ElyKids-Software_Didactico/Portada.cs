...
namespace ElyKids_Software_Didactico
{
    ...
    {
        int numImagenes;
        public Portada(string titulo, string num, string img1)
        {
            InitializeComponent();
        ...
        public Portada(int TipoActividad)
        {
            InitializeComponent();
            PictureBox pb1 = new PictureBox();
            pb1.BackgroundImage = global::ElyKids_Software_Didactico.Properties.Resources.Completa_la_palabra_PhotoRoom_png_PhotoRoom__1_;
            pb1.Size = new Size(436, 260);
            pb1.BackgroundImageLayout = ImageLayout.Stretch;
            pb1.Location = new Point(267, 240);
            this.Controls.Add(pb1);
        ...
        private void PortadaLeccion_Resize(object sender, EventArgs e)
        {
            ...
            {
                this.Controls[numControles - 3].Location = new Point((this.Width / 2) - 150, 240);
                this.Controls[numControles - 2].Location = new Point((this.Width-940)/2,240);
                this.Controls[numControles - 1].Location = new Point(((this.Width - 940) / 2) + 640, 240);
            }
        }
